...
export default function DashboardPage() {
    ...
    const StatCard = ({
        ...
        <div className="stats-card">
            ...
            <p style={{ fontSize: "0.78rem", fontWeight: 700, color: "var(--text-muted)", textTransform: "uppercase", letterSpacing: "0.05em", marginBottom: "0.4rem" }}>
                {label}
            </p>
            <p style={{ fontSize: "2.1rem", fontWeight: 900, color: "var(--text)", letterSpacing: "-0.03em", lineHeight: 1 }}>
                {value}
            </p>
        </div>
    );
                    ...
                    {(isAdmin || sessionIsAdmin) && (
                        <div style={{ flexGrow: 1, minWidth: 260 }}>
                            <Combobox
                                ...
                                placeholder={companies.length > 0 ? "Sélectionner un client…" : "Aucun client"}
                            />
                        </div>
                    )}
